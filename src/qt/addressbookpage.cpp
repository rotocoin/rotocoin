    ...
    tab(tab)
{
    ...
    {
    case SendingTab:
        ui->labelExplanation->setText(tr("Esta es tu agenda de cuentas rotoCoin. Aquí puedes almacenar las cuentas de tus amigos para cuando necesites mandarles rotoCoins."));
        ui->deleteAddress->setVisible(true);
        ui->signMessage->setVisible(false);
        break;
    case ReceivingTab:
        ui->labelExplanation->setText(tr("Estas son tus cuentas rotoCoin. Quizás quieras darle una diferente a cada persona, así cuando te paguen sabrás quien te ha pagado."));
