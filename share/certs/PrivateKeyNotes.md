...
unlocked to sign the Rotocoin-Qt.app bundle.
...
allowing somebody to distribute a Rotocoin-Qt.app or rotocoin-qt-setup.exe with a valid
...
that the rotocoin-qt.exe file inside the installer had not been tampered with.
