...
#ifndef _ROTOCOINRPC_H_
#define _ROTOCOINRPC_H_ 1
...
enum RPCErrorCode
{
    ...
    // P2P client errors
    RPC_CLIENT_NOT_CONNECTED        = -9,  // Rotocoin is not connected
...
/**
 * Rotocoin RPC command dispatcher.
 */
class CRPCTable
{
private:
